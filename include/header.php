          ...
          <div class="row align-items-center">
            <div class="col col-lg-3 col-5">
              <div class="site_logo">
                <a class="site_link" href="index.php">
                  <img src="assets/images/snehbandh_black.svg" alt="Sneh Bandh - Empowering Lives, Inspiring Change: Your Journey to Wellness Begins Here.">
                </a>
              </div>
            </div>
            ...
            <div class="col col-lg-3 col-5">
              <ul class="header_btns_group unordered_list_end">
                ...
                <li>
                  <a class="btn border_dark" href="login.php">
                    <span>
                      <small>Login</small>
                      <small>Login</small>
                    </span>
                ...
                <li>
                  <a class="btn btn_dark" href="registration.php">
                    <span>
                      <small>Sign Up</small>
                      <small>Sign Up</small>
                    </span>
