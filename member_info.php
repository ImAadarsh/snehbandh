            ...
            <div class="content_wrapper" style="background-image: url('assets/images/banner/page_banner_image.png');">
              <div class="row align-items-center">
                <div class="col col-lg-6">
                  ...
                  <h1 class="page_title">Alex Edwards</h1>
            ...
            <div class="row align-items-center">
              <div class="col col-lg-6">
                <div class="details_image image_widget">
                  <img src="assets/images/mentor/mentor_details_image_1.jpg" alt="Sneh Bandh – Empowering Lives, Inspiring Change: Your Journey to Wellness Begins Here.">
                </div>
              </div>
              <div class="col col-lg-6">
                <div class="details_content ps-lg-5">
                  ...
                  <h2 class="mentor_name">Alex Edwards</h2>
            ...
            <div class="row">
                ...
                <div class="course_card style_2">
                  <div class="item_image">
                    <a href="course_details.html" data-cursor-text="View">
                      <img src="assets/images/course/course_image_1.jpg" alt="Sneh Bandh – Empowering Lives, Inspiring Change: Your Journey to Wellness Begins Here.">
                    </a>
                  </div>
              ...
              <div class="col col-lg-4">
                <div class="course_card style_2">
                  <div class="item_image">
                    <a href="course_details.html" data-cursor-text="View">
                      <img src="assets/images/course/course_image_2.jpg" alt="Sneh Bandh – Empowering Lives, Inspiring Change: Your Journey to Wellness Begins Here.">
                    </a>
                  </div>
                  <div class="item_content">
                    <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <div class="col col-lg-4">
                <div class="course_card style_2">
                  <div class="item_image">
                    <a href="course_details.html" data-cursor-text="View">
                      <img src="assets/images/course/course_image_3.jpg" alt="Sneh Bandh – Empowering Lives, Inspiring Change: Your Journey to Wellness Begins Here.">
                    </a>
                  </div>
                  <div class="item_content">
                    <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <div class="row justify-content-center">
                ...
                <div class="mentor_item">
                  <div class="mentor_image">
                    <a href="member_info.php">
                      <img src="assets/images/mentor/mentor_image_5.jpg" alt="Sneh Bandh – Empowering Lives, Inspiring Change: Your Journey to Wellness Begins Here.">
                    </a>
                  </div>
                  <div class="mentor_content">
                    <h3 class="mentor_name">
                      <a href="member_info.php">Wendy Chandler</a>
                    </h3>
              ...
              <div class="col col-lg-4 col-md-6">
                <div class="mentor_item">
                  <div class="mentor_image">
                    <a href="member_info.php">
                      <img src="assets/images/mentor/mentor_image_6.jpg" alt="Sneh Bandh – Empowering Lives, Inspiring Change: Your Journey to Wellness Begins Here.">
                    </a>
                  </div>
                  <div class="mentor_content">
                    <h3 class="mentor_name">
                      <a href="member_info.php">James Grant</a>
                    </h3>
              ...
              <div class="col col-lg-4 col-md-6">
                <div class="mentor_item">
                  <div class="mentor_image">
                    <a href="member_info.php">
                      <img src="assets/images/mentor/mentor_image_2.jpg" alt="Sneh Bandh – Empowering Lives, Inspiring Change: Your Journey to Wellness Begins Here.">
                    </a>
                  </div>
                  <div class="mentor_content">
                    <h3 class="mentor_name">
                      <a href="member_info.php">William Morgan</a>
                    </h3>
